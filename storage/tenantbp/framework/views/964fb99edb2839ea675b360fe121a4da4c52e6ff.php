            ...
            <div class="col-md-12  mt-4 mb-3">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab">
                        ...
                        <?php if(auth()->user()->can('tabel_view')): ?><a class="nav-item nav-link active" id="nav-home-tab" href="/timetracking/reports" >Табель</a><?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/job/resources/views/admin/reports.blade.php ENDPATH**/ ?>