        ...
        <div class="col-md-12 mt-4 mb-3">
            <nav>
                ...
                <?php if(auth()->user()->can('top_view')): ?><a class="nav-item nav-link" id="nav-top-tab" href="/timetracking/top">TOП</a><?php endif; ?>
                        ...
                        <?php if(auth()->user()->can('analytics_view')): ?><a class="nav-item nav-link active" id="nav-profile-tab" href="/timetracking/an">Аналитика</a><?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/job/resources/views/admin/analytics-page.blade.php ENDPATH**/ ?>