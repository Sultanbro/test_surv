<?php $__env->startSection('title', 'ОКК'); ?>
  ...
  <div class="row">
    ...
    <div class="col-md-12 mt-4 mb-3">
      <nav>
        ...
        <?php if(auth()->user()->can('quality_view')): ?><a class="nav-item nav-link active" id="nav-quality-tab" href="/timetracking/quality-control">ОКК</a><?php endif; ?>
        </div>
      </nav>
    ...
    <div class="col-md-12">
     <t-quality :groups="<?php echo e(json_encode($groups)); ?>" active_group="<?php echo e($group_id); ?>" check="<?php echo e($check); ?>" user="<?php echo e(json_encode(auth()->user())); ?>"></t-quality>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/job/resources/views/admin/quality_control.blade.php ENDPATH**/ ?>