<?php $__env->startSection('title', 'Начисления'); ?>
...
<div class="old__content">
  <div class="row">
    <div class="col-md-12   mt-4 mb-3">
      <nav>
        ...
        <?php if(auth()->user()->can('top_view')): ?><a class="nav-item nav-link" id="nav-top-tab" href="/timetracking/top">TOП</a><?php endif; ?>
                        ...
                        <?php if(auth()->user()->can('salaries_view')): ?><a class="nav-item nav-link active" id="nav-salary-tab" href="/timetracking/salaries">Начисления</a><?php endif; ?>
    ...
    <div class="col-md-12">
        <t-accrual 
          :groupss="<?php echo e(json_encode($groups)); ?>"
          ...
          :is_admin="<?php echo e(auth()->user()->is_admin == 1 && tenant('id') == 'bp' ? 'true' : 'false'); ?>"
          :can_edit="<?php echo e(auth()->user()->can('salaries_edit') ? 'true' : 'false'); ?>"
        ></t-accrual>
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/job/resources/views/admin/salary.blade.php ENDPATH**/ ?>