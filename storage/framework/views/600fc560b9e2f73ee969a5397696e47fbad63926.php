<?php $__env->startSection('title', 'Экзамены'); ?>
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <exam :groups="<?php echo e(json_encode($groups)); ?>" activeuserid="<?php echo e(json_encode(auth()->user()->id)); ?>">
                </exam>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/job/resources/views/admin/exam.blade.php ENDPATH**/ ?>