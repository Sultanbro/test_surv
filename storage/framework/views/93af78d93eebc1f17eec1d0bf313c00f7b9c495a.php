                            ...
                            <div id="list-example" class="list-group user-nav sticky">
                                ...
                                <div class="">
                                    ...
                                    <label class="my-label-6 img_url_md" for="upload_image" style="cursor:pointer;border: 1px solid #f8f8f8;background-color: unset" >
                                        ...
                                        <img style="width: 200px;height: 200px; border-radius: 10px" id="<?php echo e($user->img_url); ?>"
                                                ...
                                                <div id="adaptation_conversations" class="none-block" style="display: none">
                                                    ...
                                                    <?php $__currentLoopData = $user->adaptation_talks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $talk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-flex phone-row form-group mb-2 adaptation_talk">
                                                            ...
                                                            <div  class="col-12 col-md-3"><?php echo e($talk['day']); ?> й день
                                                                <input type="hidden" class="form-control" name="adaptation_talks[<?php echo e($key); ?>][day]" value="<?php echo e($talk['day']); ?>">
                                                            </div>

                                                            <div class="col-12 col-md-3">
                                                                <input class="form-control" type="text" name="adaptation_talks[<?php echo e($key); ?>][inter_id]" placeholder="Кто провел" value="<?php echo e($talk['inter_id']); ?>">
                                                            </div>
                                                            ...
                                                            <div class="col-12 col-md-3">
                                                                <textarea class="form-control"  name="adaptation_talks[<?php echo e($key); ?>][text]" placeholder="Комментарии" style="min-height: 40px; padding: 5px 20px 0 20px!important;"><?php echo e($talk['text']); ?></textarea>
                                                            </div>
                                                ...
                                                <?php if(isset($user)): ?>
                                                    <?php $__currentLoopData = $user->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-flex form-group m0 card-row">
                                                            <input  class="form-control mr-1 col-sm-2" type="text" name="cards[1<?php echo e($card->id); ?>][bank]" placeholder="Банк/Кошелек/..." value="<?php echo e($card->bank); ?>">
                                                            ...
                                                            <input  class="form-control mr-1 col-sm-3 card-number" type="text" name="cards[1<?php echo e($card->id); ?>][number]" placeholder="Номер карты/счета" value="<?php echo e($card->number); ?>">
