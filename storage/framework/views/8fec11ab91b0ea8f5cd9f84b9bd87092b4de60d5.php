    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="app">
                    <t-report :groups="<?php echo e(json_encode($groups)); ?>" :fines="<?php echo e(json_encode($fines)); ?>" :years="<?php echo e(json_encode($years)); ?>" activeuserid="<?php echo e(json_encode(auth()->user()->ID)); ?>" activeuserpos="<?php echo e(json_encode(auth()->user()->position_id)); ?>"></t-report>
                </div>
            </div>
        </div>
    </div>
