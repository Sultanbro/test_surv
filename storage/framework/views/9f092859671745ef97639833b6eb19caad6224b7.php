  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>419</h1>
        <h2>О нет!</h2>
        <p>Кажется Молдир сломала ваш сайт. Обратитесь к ней
        </p>
        <p>Или заново авторизуйтесь <a href="/login">по ссылке</a></p>
      </div>
    </div>
  </div>
</main>
...
<?php /**PATH /home/lemon/Development/Others/surv/resources/views/errors/419.blade.php ENDPATH**/ ?>