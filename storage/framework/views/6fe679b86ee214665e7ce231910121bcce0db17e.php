<div class="reminder" id="reminder">
    <div class="inner">
        <h5 class="text-center ae mb-5">У вас есть непрочитанные уведомления (<?php echo e($unread); ?>)</h5>
...
</style><?php /**PATH /var/www/job/resources/views/includes/reminder.blade.php ENDPATH**/ ?>