                ...
                <form  method="post" id="form">
                    <div  id="form-1" >
                        ...
                        <div class="block">
                            ...
                            <div class="mb-2">
                                <?php $__currentLoopData = $rooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="frame">
                                        <div class="d-flex drb justify-content-between mb-2">
                                            ...
                                            <div class="d-flex justify-content-start aic">
                                                <input class="form-control" name="rooks[<?php echo e($index); ?>][id]" type="hidden" value="<?php echo e($user['id']); ?>">
                                                <input class="form-control" name="rooks[<?php echo e($index); ?>][grade]" type="hidden" value="0">

                                                <div class="mb-2 rating rating-rook-<?php echo e($index); ?>">
                                                    <span class="fa fa-star" data-id="1" title="1" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="2" title="2" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="3" title="3" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="4" title="4" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="5" title="5" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="6" title="6" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="7" title="7" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="8" title="8" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="9" title="9" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="10" title="10" data-type="rook" data-index="<?php echo e($index); ?>"></span>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="block justify-content-between plus-minus pm-rook-<?php echo e($index); ?>" style="display:none;">
                                            ...
                                            <div class="justify-content-start aic mb-2 w-50 mr-2">
                                                ...
                                                <textarea class="form-control" name="rooks[<?php echo e($index); ?>][plus]"></textarea>
                                            </div>
                                            <div class="justify-content-start aic w-50">
                                                <p class="mr-2 mb-0"><b>Минусы</b></p>
                                                <p class="description">Что он делает плохо</p>
                                                <textarea class="form-control" name="rooks[<?php echo e($index); ?>][minus]"></textarea>
                                            </div>
                    ...
                    <div  id="form-2" style="display:none">
                        ...
                        <div class="block">
                            ...
                            <div class="mb-2">
                                <?php $__currentLoopData = $stars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="frame">
                                        <div class="d-flex drb justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-start aic">
                                                <input class="form-control" name="stars[<?php echo e($index); ?>][id]" type="hidden" value="<?php echo e($user['id']); ?>">
                                                <input class="form-control" name="stars[<?php echo e($index); ?>][grade]" type="hidden" value="0">

                                                <div class="mb-2 rating rating-star-<?php echo e($index); ?>">
                                                    <span class="fa fa-star" data-id="1" title="1" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="2" title="2" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="3" title="3" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="4" title="4" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="5" title="5" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="6" title="6" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="7" title="7" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="8" title="8" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="9" title="9" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                    <span class="fa fa-star" data-id="10" title="10" data-type="star" data-index="<?php echo e($index); ?>"></span>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="block justify-content-between plus-minus pm-star-<?php echo e($index); ?>" style="display:none;">

                                            <div class="justify-content-start aic mb-2 w-50 mr-2">
                                                <p class="mr-3 mb-0"><b>Плюсы</b></p>
                                                <p class="description">Что он делает хорошо</p>
                                                <textarea class="form-control" name="stars[<?php echo e($index); ?>][plus]"></textarea>
                                            </div>
                                            <div class="justify-content-start aic w-50">
                                                <p class="mr-2 mb-0"><b>Минусы</b></p>
                                                <p class="description">Что он делает плохо</p>
                                                <textarea class="form-control" name="stars[<?php echo e($index); ?>][minus]"></textarea>
                                            </div>
...
<script>
    var rooks = <?php echo e(count($rooks)); ?>;
    var stars = <?php echo e(count($stars)); ?>;
...
</html><?php /**PATH /var/www/job/resources/views/specific/estimate_your_trainer.blade.php ENDPATH**/ ?>