	...
	<div id="wrapper">
		<div id="sidebar">
			<a href="<?php echo e(url('/')); ?>" class="logo"><?php echo e(config('app.name', 'MediaSend')); ?></a>
			<strong>Меню</strong>
	...
	<?php else: ?>
<?php endif; ?><?php /**PATH /var/www/job/resources/views/includes/topbar.blade.php ENDPATH**/ ?>