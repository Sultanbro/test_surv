...
<section class="container">
	...
	<div class="questionBox" id="app">
            ...
            <div class="first" v-if="welcome">
            <h1 class="title is-6"><img src="/admin/images/logo.png" alt="" style="width:160px;margin-bottom:15px;"></h1>
                <p>Уважаемый коллега! Какими бы ни были причины расставания, мы благодарим Вас за время, силы, знания и энергию, которые Вы отдали для успешной работы и развития нашей организации, и просим заполнить эту небольшую анкету. </p>
                <p style="margin-top:15px;margin-bottom:15px">  Она поможет нам выявить причины увольнения и определить проблемы в управлении кадрами.</p>
                    <a class="button is-active" v-on:click="welcome = false" >
                        Начать
                    </a>
             </div>
		...
		<transition :duration="{ enter: 500, leave: 300 }" enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" mode="out-in">
                ...
                <div class="questionContainer" v-if="questionIndex<quiz.questions.length" v-bind:key="questionIndex">
                    ...
                    <div class="header">
                        ...
                        <div class="progressContainer">
                            ...
                            <p>{{( Number(questionIndex/quiz.questions.length)).toFixed(2) * 100}}% заполнено</p>
                        </div>
                        <!--/progress-->
                    </div>
                    ...
                    <footer class="questionFooter">
                        ...
                        <nav class="pagination" role="navigation" aria-label="pagination">
                            ...
                            <!-- next button -->
                                <a class="button" v-if="(userResponses[questionIndex]!=null)" :class="(userResponses[questionIndex]==null)?'':'is-active'" v-on:click="next();" :disabled="questionIndex>=quiz.questions.length">
                                Следующий
                                </a>
                ...
                <div v-if="questionIndex >= quiz.questions.length" v-bind:key="questionIndex" class="quizCompleted has-text-centered">
                    ...
                    <p class="subtitle">
                        Огромное спасибо за то, что уделили время для заполнения анкеты. <br>
                        Ваши ответы помогают нам улучшить условия работы. <br>
                        Хорошего вам дня! 
                    </p>
                        <br>
...
var quiz = {
      user: "BP",
      questions: [
        <?php $__currentLoopData = $quiz; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         {
            text: "<?php echo e($question['q']); ?>",
            type: "<?php echo e($question['type']); ?>",
            responses: [
              <?php if($question['type'] == 'variant' || $question['type'] == 'answer'): ?>
               <?php $__currentLoopData = $question['answers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($a['text'] != 'Другое'): ?>
                 { text: "<?php echo e($a['text']); ?>" },
                <?php else: ?>
                 { text: "", type: 'input' },
                <?php endif; ?>
...
var app = new Vue({
   ...
   methods: {
      ...
      score: function() {
         ...
         axios.post('/api/intellect/save_quiz_after_fire', {
...
</html><?php /**PATH /var/www/job/resources/views/specific/quiz_after_fire.blade.php ENDPATH**/ ?>