<template>
  <div class="messenger__chat-item-container messenger__text-ellipsis">
    ...
    <div class="messenger__short-name-container" v-if="!fullscreen">


      <div v-if="item.private && item.image" @click="toggleInfoPanel" class="messenger__avatar messenger__clickable"
           :style="'background-image: url(\'' + item.image + '\');'"></div>
      <div v-else class="messenger__chat-name_short messenger__text-ellipsis messenger__text-center"
           v-text="item.title[0]"></div>

      <div class="messenger__chat-name-label">
