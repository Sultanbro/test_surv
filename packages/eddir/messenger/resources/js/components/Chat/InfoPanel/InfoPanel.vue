<template>
  <div v-if="isInfoPanel && chat" class="messenger__info-container">
    <div class="messenger__chat-info">
      <div class="messenger__chat-info-title" v-if="!chat.private">
        <div v-if="!editMode" @click="editMode = true" class="messenger__chat-info-title-text">
        ...
        <div v-if="editMode" @keyup.enter="changeTitle" class="messenger__chat-info-title-text">
          <input v-model="chat.title" type="text" class="messenger__chat-info-title-input"
                 placeholder="Enter chat name">
          <div class="messenger__chat-info__button">
            <svg @click="changeTitle" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 448 512">
              <path
      ...
      <div class="messenger__chat-info-members">
        <div class="messenger__chat-info-members-list">
          <div class="messenger__chat-info-members-list-item" v-for="member in chat.users">
            ...
            <div v-if="!chat.private && member.id !== user.id" @click="removeMembers([member])"
                 class="messenger__chat-info-members-list-item-remove">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 320 512" fill="#9ca6af">
                <path
