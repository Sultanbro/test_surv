...
<template>
    <DefaultLayout>
                        ...
                        <div class="data-information d-flex">
                            ...
                            <template v-else>
                                <button
                                    ...
                                    class="btn btn-primary mr-2 rounded"
                                    @click.prevent="submit(false, true)"
                                >Пригласить без стажировки</button>
                                <button
                                    id="submit_trainee"
                                    class="btn btn-warning mr-2 rounded"
                                    @click.prevent="submit(true, false)"
                                >Пригласить со стажировкой</button>
                            </template>
                                ...
                                <template v-if="!user.deleted_at">
                                    ...
                                    <template v-else>
                                        <button
                                            ...
                                            v-b-modal.modal-deactivate
                                            @click.prevent="delay = 0"
                                        >Уволить без отработки</button>
                                        <button
                                            type="button"
                                            id="deleteModalBtn2"
                                            class="btn btn-danger rounded"
                                            v-b-modal.modal-deactivate
                                            @click.prevent="delay = 1"
                                        >Уволить с отработкой</button>
                                    </template>
                                </template>
                                <button
                                    v-else
        ...
        <div class="svg-icons" style="display: none !important;">
            ...
            <svg viewBox="0 0 512 512" id="xls-icon">
            ...
            <svg viewBox="0 0 512 512" id="xlsx-icon">
                <path style="fill:#E2E5E7;" d="M128,0c-17.6,0-32,14.4-32,32v448c0,17.6,14.4,32,32,32h320c17.6,0,32-14.4,32-32V128L352,0H128z"/>
                <path style="fill:#B0B7BD;" d="M384,128h96L352,0v96C352,113.6,366.4,128,384,128z"/>
                <polygon style="fill:#CAD1D8;" points="480,224 384,128 480,128 "/>
                <path style="fill:#84BD5A;" d="M416,416c0,8.8-7.2,16-16,16H48c-8.8,0-16-7.2-16-16V256c0-8.8,7.2-16,16-16h352c8.8,0,16,7.2,16,16  V416z"/>
            ...
            <svg viewBox="0 0 512 512" id="ppt-icon">
                <g>
            ...
            <svg viewBox="0 0 512 512" id="pptx-icon">
                <g>
                    <path style="fill:#E9E9E0;" d="M36.985,0H7.963C7.155,0,6.5,0.655,6.5,1.926V55c0,0.345,0.655,1,1.463,1h40.074   c0.808,0,1.463-0.655,1.463-1V12.978c0-0.696-0.093-0.92-0.257-1.085L37.607,0.257C37.442,0.093,37.218,0,36.985,0z"/>
                    <polygon style="fill:#D9D7CA;" points="37.5,0.151 37.5,12 49.349,12  "/>
                    <path style="fill:#F6712E;" d="M48.037,56H7.963C7.155,56,6.5,55.345,6.5,54.537V39h43v15.537C49.5,55.345,48.845,56,48.037,56z"/>
            ...
            <svg viewBox="0 0 512 512" id="rar-icon">
                ...
                <g>
                    ...
                    <path style="fill:#FFFFFF;" d="M313.975,110.933v-25.6c0-4.713-3.821-8.533-8.533-8.533h-34.133c-4.713,0-8.533,3.821-8.533,8.533   v51.2c0,4.713,3.821,8.533,8.533,8.533c4.713,0,8.533-3.821,8.533-8.533v-17.067h3.967l14.533,21.801   c1.644,2.467,4.35,3.801,7.108,3.801c6.711,0,10.791-7.719,7.091-13.267l-8.222-12.334h1.122   C310.154,119.467,313.975,115.646,313.975,110.933z M279.841,93.867h17.067v8.533h-17.067V93.867z"/>
                    <path style="fill:#FFFFFF;" d="M236.737,82.635c-1.162-3.485-4.422-5.835-8.095-5.835s-6.933,2.351-8.095,5.835l-17.067,51.2   c-1.49,4.47,0.926,9.303,5.397,10.794c4.471,1.489,9.303-0.927,10.794-5.397l8.972-26.913l8.972,26.913   c1.191,3.577,4.522,5.838,8.094,5.837c5.742,0,9.907-5.801,8.097-11.234L236.737,82.635z"/>
                </g>
                <path style="fill:#FFC44F;" d="M228.641,349.867h153.6V256h-153.6c-18.851,0-34.133,15.282-34.133,34.133v25.6  C194.508,334.585,209.79,349.867,228.641,349.867z"/>
                <path style="fill:#FFD791;" d="M224.375,332.8c-7.069,0-12.8-5.731-12.8-12.8v-34.133c0-7.069,5.731-12.8,12.8-12.8h157.867V332.8  H224.375z"/>
                <path style="fill:#DB6B5E;" d="M399.308,358.4h-179.2c-18.821,0-34.133-15.312-34.133-34.133V281.6  c0-18.821,15.312-34.133,34.133-34.133h179.2c4.713,0,8.533,3.821,8.533,8.533c0,4.713-3.821,8.533-8.533,8.533h-179.2  c-9.41,0-17.067,7.657-17.067,17.067v42.667c0,9.41,7.657,17.067,17.067,17.067h179.2c4.713,0,8.533,3.821,8.533,8.533  C407.841,354.579,404.02,358.4,399.308,358.4z"/>
                <g>
                    <path style="fill:#F79F4D;" d="M228.641,290.133c0,4.713,3.821,8.533,8.533,8.533h145.067V281.6H237.175   C232.462,281.6,228.641,285.421,228.641,290.133z"/>
                    <path style="fill:#F79F4D;" d="M237.175,307.2c-4.713,0-8.533,3.821-8.533,8.533c0,4.713,3.821,8.533,8.533,8.533h145.067V307.2   H237.175z"/>
                </g>
                <path style="fill:#FFC44F;" d="M228.641,460.8h153.6v-93.867h-153.6c-18.851,0-34.133,15.282-34.133,34.133v25.6  C194.508,445.518,209.79,460.8,228.641,460.8z"/>
                <path style="fill:#FFD791;" d="M224.375,443.733c-7.069,0-12.8-5.731-12.8-12.8V396.8c0-7.069,5.731-12.8,12.8-12.8h157.867v59.733  H224.375z"/>
                <path style="fill:#FF8C78;" d="M399.308,469.333h-179.2c-18.821,0-34.133-15.312-34.133-34.133v-42.667  c0-18.821,15.312-34.133,34.133-34.133h179.2c4.713,0,8.533,3.821,8.533,8.533s-3.821,8.533-8.533,8.533h-179.2  c-9.41,0-17.067,7.657-17.067,17.067V435.2c0,9.41,7.657,17.067,17.067,17.067h179.2c4.713,0,8.533,3.821,8.533,8.533  S404.02,469.333,399.308,469.333z"/>
                <g>
                    <path style="fill:#F79F4D;" d="M228.641,401.067c0,4.713,3.821,8.533,8.533,8.533h145.067v-17.067H237.175   C232.462,392.533,228.641,396.354,228.641,401.067z"/>
                    <path style="fill:#F79F4D;" d="M237.175,418.133c-4.713,0-8.533,3.821-8.533,8.533s3.821,8.533,8.533,8.533h145.067v-17.067   H237.175z"/>
                </g>
                <path style="fill:#55606E;" d="M357.821,217.2c-3.526-5.859-9.123-9.994-15.759-11.643c-6.637-1.648-13.518-0.615-19.376,2.911  c-6.329,3.809-16.24,17.498-23.354,28.164c-7.113-10.667-17.025-24.355-23.353-28.164c-12.098-7.281-27.855-3.362-35.136,8.731  c-7.279,12.094-3.362,27.856,8.732,35.135c6.834,4.114,25.812,6.529,38.8,7.745v209.43h17.067V260.506  c12.538-1.026,35.899-3.505,43.649-8.171c5.858-3.526,9.993-9.123,11.642-15.759C362.381,229.939,361.346,223.058,357.821,217.2z   M258.377,237.713c-4.031-2.427-5.338-7.681-2.911-11.711c2.393-3.973,7.726-5.311,11.707-2.914  c2.58,1.618,8.833,9.723,15.355,19.203C271.099,240.967,261.013,239.235,258.377,237.713z M344.169,232.461  c-0.549,2.212-1.927,4.078-3.874,5.249c-2.638,1.522-12.725,3.255-24.156,4.579c6.521-9.481,12.772-17.582,15.348-19.198  c3.987-2.401,9.314-1.071,11.711,2.911C344.373,227.955,344.718,230.249,344.169,232.461z"/>
            </svg>

            <svg viewBox="0 0 512 512" id="pdf-icon">
                <path style="fill:#E2E5E7;" d="M128,0c-17.6,0-32,14.4-32,32v448c0,17.6,14.4,32,32,32h320c17.6,0,32-14.4,32-32V128L352,0H128z"/>
                <path style="fill:#B0B7BD;" d="M384,128h96L352,0v96C352,113.6,366.4,128,384,128z"/>
                <polygon style="fill:#CAD1D8;" points="480,224 384,128 480,128 "/>
            ...
            <svg viewBox="0 0 512 512"   id="png-icon">
                <path style="fill:#E2E5E7;" d="M128,0c-17.6,0-32,14.4-32,32v448c0,17.6,14.4,32,32,32h320c17.6,0,32-14.4,32-32V128L352,0H128z"/>
                <path style="fill:#B0B7BD;" d="M384,128h96L352,0v96C352,113.6,366.4,128,384,128z"/>
                <polygon style="fill:#CAD1D8;" points="480,224 384,128 480,128 "/>
            ...
            <svg id="download-icon" viewBox="0 0 20 17">
                <path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z" style=""></path>
            </svg>

            <svg id="jpg-icon" viewBox="0 0 58 58" >
                <g id="Page-1" fill="none" fill-rule="evenodd"><g id="040---JPG" fill-rule="nonzero"><path id="Shape" d="m46 14v43c0 .5522847-.4477153 1-1 1h-44c-.55228475 0-1-.4477153-1-1v-56c0-.55228475.44771525-1 1-1h31z" fill="#2fa8cc"/><path id="Shape" d="m33 14h13l-14-14v13c0 .5522847.4477153 1 1 1z" fill="#67b9cc"/><path id="Shape" d="m28.86 29.72-17.86 28.28h-10c-.55228475 0-1-.4477153-1-1v-13.81l11.16-16.74 5.71-8.57c.3616676-.539975.9645441-.8689524 1.614339-.8809118.649795-.0119594 1.2643687.2946109 1.645661.8209118l6.05 8.25z" fill="#3f5c6c"/><path id="Shape" d="m46 37.6v19.4c0 .5522847-.4477153 1-1 1h-34l17.86-28.28.04-.06 4.4-6.97c.3691068-.5803816 1.0099482-.9310557 1.6977552-.9290267.6878071.0020289 1.3265684.3564776 1.6922448.9390267l4.37 7z" fill="#35495e"/><rect id="Rectangle-path" fill="#f0c419" height="18" rx="1" width="42" x="16" y="34"/><circle id="Oval" cx="11" cy="11" fill="#f0c419" r="3"/><g fill="#f3d55b"><path id="Shape" d="m11 6c-.5522847 0-1-.44771525-1-1v-1c0-.55228475.4477153-1 1-1s1 .44771525 1 1v1c0 .55228475-.4477153 1-1 1z"/><path id="Shape" d="m5 12h-1c-.55228475 0-1-.4477153-1-1s.44771525-1 1-1h1c.55228475 0 1 .4477153 1 1s-.44771525 1-1 1z"/><path id="Shape" d="m11 19c-.5522847 0-1-.4477153-1-1v-1c0-.5522847.4477153-1 1-1s1 .4477153 1 1v1c0 .5522847-.4477153 1-1 1z"/><path id="Shape" d="m18 12h-1c-.5522847 0-1-.4477153-1-1s.4477153-1 1-1h1c.5522847 0 1 .4477153 1 1s-.4477153 1-1 1z"/></g><path id="Shape" d="m30 37h-6c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h2v6.5c0 .8284271-.6715729 1.5-1.5 1.5s-1.5-.6715729-1.5-1.5v-.5c0-.5522847-.4477153-1-1-1s-1 .4477153-1 1v.5c.0000001 1.9329966 1.5670034 3.4999999 3.5 3.4999999s3.4999999-1.5670033 3.5-3.4999999v-6.5h2c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1z" fill="#3d324c"/><path id="Shape" d="m37.5 37h-3.5c-.5522847 0-1 .4477153-1 1v10c0 .5522847.4477153 1 1 1s1-.4477153 1-1v-4h2.5c1.9329966 0 3.5-1.5670034 3.5-3.5s-1.5670034-3.5-3.5-3.5zm0 5h-2.5v-3h2.5c.8284271 0 1.5.6715729 1.5 1.5s-.6715729 1.5-1.5 1.5z" fill="#3d324c"/><path id="Shape" d="m52 43h-4c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h1v1c0 .5522847-.4477153 1-1 1h-2c-.5522847 0-1-.4477153-1-1v-6c0-.5522847.4477153-1 1-1h2c.5522847 0 1 .4477153 1 1s.4477153 1 1 1 1-.4477153 1-1c0-1.6568542-1.3431458-3-3-3h-2c-1.6568542 0-3 1.3431458-3 3v6c0 1.6568542 1.3431458 3 3 3h2c1.6568542 0 3-1.3431458 3-3v-1h1c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1z" fill="#3d324c"/><path id="Shape" d="m26.18 26.07-2.77 3.15c-.1787951.2050126-.4333938.3283393-.7050984.3415471-.2717046.0132079-.5370647-.084843-.7349016-.2715471l-2.78-2.64c-.3896281-.3598394-.9903719-.3598394-1.38 0l-2.78 2.64c-.1978369.1867041-.463197.284755-.7349016.2715471-.2717046-.0132078-.5263033-.1365345-.7050984-.3415471l-2.43-2.77 5.71-8.57c.3616676-.539975.9645441-.8689524 1.614339-.8809118.649795-.0119594 1.2643687.2946109 1.645661.8209118z" fill="#d1d4d1"/><path id="Shape" d="m41.06 29.7-.89.96c-.4048186.4295623-1.0774137.4605371-1.52.07l-2.93-2.64c-.41331-.3578334-1.02669-.3578334-1.44 0l-2.93 2.64c-.4425863.3905371-1.1151814.3595623-1.52-.07l-.93-1 4.4-6.97c.3691068-.5803816 1.0099482-.9310557 1.6977552-.9290267.6878071.0020289 1.3265684.3564776 1.6922448.9390267z" fill="#ecf0f1"/></g></g>
            </svg>
            <svg id="jpeg-icon" viewBox="0 0 58 58" >
                <g id="Page-1" fill="none" fill-rule="evenodd"><g id="040---JPG" fill-rule="nonzero"><path id="Shape" d="m46 14v43c0 .5522847-.4477153 1-1 1h-44c-.55228475 0-1-.4477153-1-1v-56c0-.55228475.44771525-1 1-1h31z" fill="#2fa8cc"/><path id="Shape" d="m33 14h13l-14-14v13c0 .5522847.4477153 1 1 1z" fill="#67b9cc"/><path id="Shape" d="m28.86 29.72-17.86 28.28h-10c-.55228475 0-1-.4477153-1-1v-13.81l11.16-16.74 5.71-8.57c.3616676-.539975.9645441-.8689524 1.614339-.8809118.649795-.0119594 1.2643687.2946109 1.645661.8209118l6.05 8.25z" fill="#3f5c6c"/><path id="Shape" d="m46 37.6v19.4c0 .5522847-.4477153 1-1 1h-34l17.86-28.28.04-.06 4.4-6.97c.3691068-.5803816 1.0099482-.9310557 1.6977552-.9290267.6878071.0020289 1.3265684.3564776 1.6922448.9390267l4.37 7z" fill="#35495e"/><rect id="Rectangle-path" fill="#f0c419" height="18" rx="1" width="42" x="16" y="34"/><circle id="Oval" cx="11" cy="11" fill="#f0c419" r="3"/><g fill="#f3d55b"><path id="Shape" d="m11 6c-.5522847 0-1-.44771525-1-1v-1c0-.55228475.4477153-1 1-1s1 .44771525 1 1v1c0 .55228475-.4477153 1-1 1z"/><path id="Shape" d="m5 12h-1c-.55228475 0-1-.4477153-1-1s.44771525-1 1-1h1c.55228475 0 1 .4477153 1 1s-.44771525 1-1 1z"/><path id="Shape" d="m11 19c-.5522847 0-1-.4477153-1-1v-1c0-.5522847.4477153-1 1-1s1 .4477153 1 1v1c0 .5522847-.4477153 1-1 1z"/><path id="Shape" d="m18 12h-1c-.5522847 0-1-.4477153-1-1s.4477153-1 1-1h1c.5522847 0 1 .4477153 1 1s-.4477153 1-1 1z"/></g><path id="Shape" d="m30 37h-6c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h2v6.5c0 .8284271-.6715729 1.5-1.5 1.5s-1.5-.6715729-1.5-1.5v-.5c0-.5522847-.4477153-1-1-1s-1 .4477153-1 1v.5c.0000001 1.9329966 1.5670034 3.4999999 3.5 3.4999999s3.4999999-1.5670033 3.5-3.4999999v-6.5h2c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1z" fill="#3d324c"/><path id="Shape" d="m37.5 37h-3.5c-.5522847 0-1 .4477153-1 1v10c0 .5522847.4477153 1 1 1s1-.4477153 1-1v-4h2.5c1.9329966 0 3.5-1.5670034 3.5-3.5s-1.5670034-3.5-3.5-3.5zm0 5h-2.5v-3h2.5c.8284271 0 1.5.6715729 1.5 1.5s-.6715729 1.5-1.5 1.5z" fill="#3d324c"/><path id="Shape" d="m52 43h-4c-.5522847 0-1 .4477153-1 1s.4477153 1 1 1h1v1c0 .5522847-.4477153 1-1 1h-2c-.5522847 0-1-.4477153-1-1v-6c0-.5522847.4477153-1 1-1h2c.5522847 0 1 .4477153 1 1s.4477153 1 1 1 1-.4477153 1-1c0-1.6568542-1.3431458-3-3-3h-2c-1.6568542 0-3 1.3431458-3 3v6c0 1.6568542 1.3431458 3 3 3h2c1.6568542 0 3-1.3431458 3-3v-1h1c.5522847 0 1-.4477153 1-1s-.4477153-1-1-1z" fill="#3d324c"/><path id="Shape" d="m26.18 26.07-2.77 3.15c-.1787951.2050126-.4333938.3283393-.7050984.3415471-.2717046.0132079-.5370647-.084843-.7349016-.2715471l-2.78-2.64c-.3896281-.3598394-.9903719-.3598394-1.38 0l-2.78 2.64c-.1978369.1867041-.463197.284755-.7349016.2715471-.2717046-.0132078-.5263033-.1365345-.7050984-.3415471l-2.43-2.77 5.71-8.57c.3616676-.539975.9645441-.8689524 1.614339-.8809118.649795-.0119594 1.2643687.2946109 1.645661.8209118z" fill="#d1d4d1"/><path id="Shape" d="m41.06 29.7-.89.96c-.4048186.4295623-1.0774137.4605371-1.52.07l-2.93-2.64c-.41331-.3578334-1.02669-.3578334-1.44 0l-2.93 2.64c-.4425863.3905371-1.1151814.3595623-1.52-.07l-.93-1 4.4-6.97c.3691068-.5803816 1.0099482-.9310557 1.6977552-.9290267.6878071.0020289 1.3265684.3564776 1.6922448.9390267z" fill="#ecf0f1"/></g></g>
            </svg>
        </div>
