...
Vue.component(
	'ChatSidepanel',
	require('./components/Chat/ChatSidePanel/ChatSidePanel.vue').default
);
Vue.component(
	'ChatSearchButton',
	require('./components/Chat/ChatSearchButton/ChatSearchButton.vue').default
);
...
Vue.component(
	'ActivityExcelImport',
	require('./components/imports/ActivityExcelImport.vue').default
); // импорт в активности
...
Vue.component(
	'LeftSidebar',
	require('./pages/Layouts/LeftSidebar.vue').default
);
Vue.component(
	'RightSidebar',
	require('./pages/Layouts/RightSidebar.vue').default
);
Vue.component(
	'ProfileSidebar',
	require('./pages/Layouts/ProfileSidebar.vue').default
);
Vue.component('Sidebars', require('./pages/Layouts/Sidebars.vue').default);

Vue.component(
	'PopupChecklist',
	require('./pages/Layouts/CheckListPopup.vue').default
);
Vue.component(
	'PopupNotifications',
	require('./pages/Layouts/NotificationsPopup.vue').default
);
Vue.component(
	'PopupSearch',
	require('./pages/Layouts/SearchPopup.vue').default
);
