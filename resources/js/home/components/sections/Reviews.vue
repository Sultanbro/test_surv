<template>
  <section id="jReviews">
    <a name="reviews" id="reviews" class="ancor"/>
    <div class="section-content">
      ...
      <div class="jReviews-wrapper">
        ...
        <div class="jReviews-footer">
          ...
          <a href="javascript:void(0)" class="jReviews-free jButton">
...
#jReviews
  width 100%
  background url(../../assets/reviews-bg.svg) no-repeat
