        ...
        <div class="jSec1-tabs-content">
          <div class="jSec1-tabs-item jSec1-profile" v-show="activeTab === 'profile'">
            ...
            <div class="jSec1-profile-banner">
              <img src="@/assets/s1-profile-banner.png" alt="" class="jSec1-profile-banner-img">
            </div>
          </div>
...
#jSec1
  ...
  min-height 100vh
  padding-top 1rem
  background-image url(../../assets/s1-bg.svg)
...
.jSec1-tabs-qm
  ...
  background-image url(../../assets/s1-qm.svg)
...
.jSec1-profile-list-item
  ...
  &:before
    ...
    background-image url(../../assets/s1-dot.svg)
...
@media screen and (min-width: $medium)
  #jSec1
    background-image url(../../assets/s1-bg.svg), url(../../assets/s1-bg-2.svg)
