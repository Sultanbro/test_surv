<template>
	<div class="trainee_report">
		<div>
			<div
				class="ramka mt-2"
				v-for="(report_date, rdate) in trainee_report"
				:key="rdate"
			>
					...
					<tbody>
						<tr>
							<td class="text-left t-name table-title align-middle">
								<div
									v-for="answer in report_date['quiz'][1]"
									:key="answer.id"
									class="d-flex"
								>
									<progress-bar
							...
							<td class="text-left t-name table-title align-middle">
								<div
									v-for="answer in report_date['quiz'][2]"
									:key="answer.id"
									class="d-flex"
								>
									<progress-bar
							...
							<td class="text-left t-name table-title align-middle">
								<div
									v-for="answer in report_date['quiz'][3]"
									:key="answer.id"
									class="d-flex"
								>
									<progress-bar
							...
							<td class="text-left t-name table-title align-middle">
								...
								>
									<Rating
										:grade="Number(report_date['quiz'][4]['avg']).toFixed(0)"
										:max-stars="10"
										:has-counter="false"
									/>
									<p class="mb-0">
										{{ report_date['quiz'][4]['avg'] + ' (' + report_date['quiz'][4]['count'] + ')' }}
									</p>
								</div>
							</td>
							<td class="text-left t-name table-title align-middle">
								<div
									v-for="(answer, ind) in report_date['quiz'][5]"
									:key="ind"
									class="d-flex"
								>
									<p class="fz12">
					...
					<tbody>
						<tr>
							...
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][1] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][2] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][3] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][4] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][5] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][6] }}
							</td>
							<td class="text-center t-name table-title align-middle">
								{{ report_date['presence'][7] }}
							</td>
						</tr>
					</tbody>
				</table>
