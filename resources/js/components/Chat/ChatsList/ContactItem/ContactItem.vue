<template>
	<div class="messenger__chat-item-container messenger__text-ellipsis">
		<div
			...
			class="messenger__avatar messenger__clickable"
		>
			<img
				:src="item.image"
				:alt="item.name"
		...
		<div
			v-else
			class="messenger__short-name-container"
		>
			<div
				class="messenger__chat-name_short messenger__text-ellipsis messenger__text-center"
				v-text="item.title[0]"
			/>
		...
		>
			<div class="messenger__title_container">
				<div
					class="messenger__chat-name messenger__text-ellipsis"
					v-text="item.title"
				/>
			</div>
			<template v-if="item.unread_messages_count > 0">
				<div
					class="messenger__last-message messenger__last-message__marked"
