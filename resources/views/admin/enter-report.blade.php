                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab">
                        ...
                        @if(auth()->user()->can('tabel_view'))<li class="nav-item"><a class="nav-link" id="nav-home-tab" href="/timetracking/reports" >Табель</a></li>@endif
                            @if(auth()->user()->can('entertime_view'))<li class="nav-item"><a class="nav-link active" id="nav-home-tab" href="/timetracking/reports/enter-report" >Время прихода</a></li>@endif
