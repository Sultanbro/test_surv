                    ...
                    <li class="root-item ">
                        ...
                        <div class="slide-ac">
                            <ul>
                                ...
                                <li><a href="{{route('partner.about')}}" class="">О партнерке</a></li>
                                <li><a href="{{route('partner.edit')}}" class="">Карточка партнера</a></li>
                                <li><a href="{{route('partner.info')}}" class="">Персональная ссылка</a></li>
                                <li><a href="{{route('partner.dok')}}" class="">Маркетинговая поддержка</a></li>
                                <li><a href="{{route('partner.index')}}" class="">Курс для менеджера</a></li>
                                <li><a href="{{route('partner.faq')}}" class="">Частые вопросы</a></li>
                                <li><a href="{{route('partner.statistic')}}" class="">Статистика продаж и выплат</a></li>
                                @else
                                <li><a href="{{route('partner.add')}}" class="">Заявка на партнерство</a></li>
                                @endif
                            </ul>
                        </div>
                    </li>
