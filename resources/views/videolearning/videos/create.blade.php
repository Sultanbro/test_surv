...
<form class="col-lg-12 mt-2" action="/videos" method="POST">
    <div class="row">
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <input type="text" class="form-control" value="" name="links" id="link">
            </div>
        </div>   
        <div class="col-lg-6">
            <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <input type="number" class="form-control" value="0" name="duration">
            </div>
        </div>
        <div class="col-lg-12">
