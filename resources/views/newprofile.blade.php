...
<!--									</div>-->
		...
		<div class="popup  notifications js-popup">
			<div class="popup__content">
				<div class="popup-header">
					<a class="popup-close js-close-popup" href="#" ><img src="images/dist/popup-close.svg" alt="Close icon" ></a>
					<div class="popup__header-content">
					...
					<div class="tabs ">
						...
						<div class="tab__content">
							<div class="kaspi__content custom-scroll-y tab__content-item is-active"  data-content="1">
								...
								<a href="#" class="notifications__button">
		...
		<div class="popup  check js-popup">
			<div class="popup__content">
				<div class="popup-header">
					<a class="popup-close js-close-popup" href="#" ><img src="images/dist/popup-close.svg" alt="Close icon" ></a>
					<div class="popup__header-content">
				...
				<div class="popup__body">
					...
					<div class="check__item">
						...
						<input class="check__url" type="text" placeholder="URL">
					</div>
					<div class="check__item">
						<label class="check__checkbox">
							<input type="checkbox">
