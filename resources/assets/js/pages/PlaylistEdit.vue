...
<div class="p-3">
        ...
        <div class="col-lg-6">
            <div>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" v-model="playlist.title" name="title">
                </div>

                <div class="form-group"> 
                    <label for="playlist_id">Категория</label>
                    <select name="category_id" class="form-control" v-model="playlist.category_id">
        ...
        <div class="col-lg-6">
           <div>
                <div class="form-group"> 
                    ...
                    <textarea name="text" class="form-control" required v-model="playlist.text"></textarea>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-6 mb-2">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <button class="btn btn-sm mr-2" @click="modals.addVideo.show = true">Добавить</button>
                    <button class="btn btn-sm" @click="modals.upload.show = true">Загрузить видео</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
                <draggable 
                    ...
                    <template v-for="(video, v_index) in playlist.videos">
                        <div class="video-block" :key="video.id" @click.stop="showVideoSettings(video)">
                            <div class="mover">
    ...
    <b-modal v-model="modals.addVideo.show" hide-footer title="Добавить видео из существующих" size="lg">
        <div class="video-search">
            <input type="text" class="search-input form-control" @keyup="search($event)">
            <div class="items">
                <div v-for="video in modals.addVideo.searchVideos" 
                    class="item d-flex" 
    ...
    <b-modal v-model="modals.upload.show" hide-footer title="Загрузить видео" size="lg">
            <div class="steps">
                <p :class="{'active': modals.upload.step == 1}" @click="moveToStep(1)" class="mr-2"><b>1. Загрузить видео ></b></p>
                <p :class="{'active': modals.upload.step == 2}" @click="moveToStep(2)"><b>2. Редактировать видео</b></p>
            </div>
            <div v-if="modals.upload.step == 1">
                ...
                <div class="uploaded_files" v-if="modals.upload.file !== null">
                    <p><b>Загружено {{ Number(modals.upload.file.size / 1024 / 1024).toFixed(3) }}mb</b></p>
            ...
            <div v-if="modals.upload.step == 2">
                 ...
                 <div class="row mb-2" v-if="modals.upload.file !== null">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" v-model="modals.upload.file.video.title">
                    </div>
                    <div class="col-md-12">
                        <p><b>Загружено {{ Number(modals.upload.file.size / 1024 / 1024).toFixed(3) }}mb</b></p>
                        <p>{{ modals.upload.file.name }}</p>
...
export default {
    ...
    methods: {
        ...
        removeVideo(v_index) {
            ...
            axios.post('/playlists/remove-video', {
                id: video.id,
            }).then(response => {
        ...
        deleteVideo() {
            axios.post('/playlists/delete-video', {
        ...
        saveVideo() {
            ...
            axios.post('/playlists/save-video', {
                id: this.playlist.id,
        ...
        saveActiveVideo() {
            ...
            axios.post('/playlists/save-active-video', {
                id: this.playlist.id,
        ...
        search(event) {
            this.modals.addVideo.searchVideos = this.all_videos.filter(el => {
                ...
                return el.title.toLowerCase().indexOf(event.target.value.toLowerCase()) > -1
            }) 
        ...
        addVideo(id) {
            ...
            axios.post('/playlists/add-video', {
                id: this.playlist.id,
                video_id: id,
            }).then(response => {
        ...
        fetchData() {
            axios.get('/playlists/get/' + this.id)
            .then(response => {
