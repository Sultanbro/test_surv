...
class UserStat extends Model
{
    ...
    public static function activities($group_id, $date)
    {
        ...
        $acts = Activity::query()
            ...
            ->whereIn('view', [Activity::VIEW_DEFAULT, Activity::VIEW_COLLECTION, Activity::VIEW_QUALITY])
            ->orderBy('order', 'desc')
            ->get();
    ...
    public static function getTimeTrackingActivity($user, $dayInMonth, $timeAddress): ?Model
    {
        return self::query()
