...
class BookController extends Controller
{
    ...
    public function index()
    {
        ...
        dd(Position::getBookGroups(645645));
    }
    ...
    {   
        ...
        return response()->json([
            'books' => Book::withGroups($group_id),
    ...
    */
    ...
    {
        $book_id = Book::createBook($request['title'], $request['author'], $request['link']);
        BookGroup::addBooks($request['group_id'], [
            ['id' => $book_id]
        ]);
