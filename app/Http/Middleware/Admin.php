...
class Admin {
    ...
    public function handle($request, Closure $next) {
        ...
        Auth::user()->can = [
            ...
            'analytics_view' => $user->is_admin == 1 || in_array($user->id, [13410,4444,5,11533,5494,12787,13583,3782,4593,3794,3423,3865,3957,1739,2966,13337,3423,13410,3865,4143,6288,5673]),
