...
class Admin {
    ...
    public function handle($request, Closure $next) {
        ...
        Auth::user()->can = [
            ...
            'tabel_view' => $user->is_admin == 1 || in_array($user->id, [5263,9974,11533,5494,12787,1358, 3460]),
            ...
            'quality_view' => $user->is_admin == 1 || in_array($user->id, [11533,5494,12787,13583,3460,3423,3794,3965,4143,5494,8257,9974,11208]),
