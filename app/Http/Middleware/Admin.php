...
class Admin {
    ...
    public function handle($request, Closure $next) {
        ...
        Auth::user()->can = [
            ...
            'tabel_view' => $user->is_admin == 1 || in_array($user->id, [5263,9974,11533,5494,12787,1358, 3460, 1739,2966,13337,3794,3423]),
            'entertime_view' => $user->is_admin == 1 || in_array($user->id, [5263,9974,11533,5494,12787,13583, 1739,2966,3794,3423]),
            'salaries_view' => $user->is_admin == 1 || in_array($user->id, [5263,9974,11533,5494,12787,13583,1739,2966,3794,3423]),
