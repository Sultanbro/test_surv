...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'adaptation_talks.*.day'    => [
                'required_with:adaptation_talks.*.date,adaptation_talks.*.text,adaptation_talks.*.inter_id',
                'string',
                'nullable',
            ],
            'adaptation_talks.*.date'   => ['required_with:adaptation_talks.*.day', 'string', 'nullable'],
            'adaptation_talks.*.text'   => ['required_with:adaptation_talks.*.day', 'string', 'nullable'],
            'adaptation_talks.*.inter_id'  => ['required_with:adaptation_talks.*.day', 'string', 'nullable'],
